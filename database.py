...
# A small library of database routines to power payments application.

import os, pprint, sqlite3
from collections import namedtuple

def open_database(path='bank.dn'):
    ...
    if new:
        ...
        add_payment(db, 'brandon', 'liz', 200, 'Payment for writing code')
