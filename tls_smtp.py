...
This is a test message sent to you from tls.py program
in Foundations od Python Networking Programming.
"""

def main():
    if len(sys.argv) < 4:
        name = sys.argv[0]
        print("Syntax: {} server fromaddr [toaddr...]".format(name))
        sys.exit(2)
