#Listing 7-6
#Foundations of Python Metwork Programming
...
def serve(listener):
    ...
    for fd, event in all_events_forever(poll_object):
        sock = sockets[fd]
        # Socket closed: remote it from our data structures.
        ...
        if event & (select.POLLHUP | select.POLLERR | select.POLLNVAL):
            ...
            if rb:
                ...
                print('Client {} closed socket normally'.format(address, sb))
       ...
       # Socket ready to send: kepp sending until all bytes are delivered.
